...
<main class="form-input">
  ...
  ?>
            ...
            <form action="prosesedit?itemid=<?php echo $itemid; ?>" method="post" autocomplete="off">
                <div class="form-floating">
                    <input type="text" name="itemname" class="form-control" id="floatingInput1" value="<?php echo $itemname; ?>">
                    <label for="floatingInput1">Nama Produk</label>
                </div>
                <div class="form-floating">
                    <input type="text" name="itemdesc" class="form-control" id="floatingInput2" value="<?php echo $itemdesc; ?>">
                    <label for="floatingInput2">Deskripsi Produk (Optional)</label>
                </div>
                <div class="form-floating">
                    <input type="number" name="itemprice" class="form-control" id="floatingInput3" oninput="harga()" value="<?php echo $itemprice; ?>">
